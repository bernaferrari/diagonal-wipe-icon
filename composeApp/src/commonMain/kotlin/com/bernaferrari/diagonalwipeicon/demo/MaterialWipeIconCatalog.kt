...
internal val coreMaterialWipeIconCatalog = listOf(
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.CommentsDisabled,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.DoNotDisturbOff,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.FlashOff,
        enabledCodeIconName = "FlashOn",
        disabledCodeIconName = "FlashOff",
    ),
    MaterialWipeIconPair(
        "Flashlight",
        MaterialSymbolIcons.FlashlightOn,
        MaterialSymbolIcons.FlashlightOff,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.HdrOff,
        enabledCodeIconName = "HdrOn",
        disabledCodeIconName = "HdrOff",
    ),
    MaterialWipeIconPair(
        "Hdr Plus",
        MaterialSymbolIcons.HdrPlus,
        MaterialSymbolIcons.HdrPlusOff,
        enabledCodeIconName = "HdrPlus",
        disabledCodeIconName = "HdrPlusOff",
    ),
    MaterialWipeIconPair(
        "Headset",
        MaterialSymbolIcons.HeadsetMic,
        MaterialSymbolIcons.HeadsetOff,
        enabledCodeIconName = "HeadsetMic",
        disabledCodeIconName = "HeadsetOff",
    ),
    MaterialWipeIconPair(
        "Hearing Aid Left",
        MaterialSymbolIcons.HearingAid,
        MaterialSymbolIcons.HearingAidDisabledLeft,
    ...
    MaterialWipeIconPair(
        "Lightbulb",
        MaterialSymbolIcons.Lightbulb,
        MaterialSymbolIcons.LightOff,
        enabledCodeIconName = "Lightbulb",
        disabledCodeIconName = "LightOff",
    ),
    MaterialWipeIconPair(
        "Location",
        MaterialSymbolIcons.LocationOn,
        MaterialSymbolIcons.LocationOff,
        enabledCodeIconName = "LocationOn",
        disabledCodeIconName = "LocationOff",
    ),
    MaterialWipeIconPair(
        "Location Searching",
        MaterialSymbolIcons.LocationSearching,
        MaterialSymbolIcons.LocationDisabled,
    ...
    MaterialWipeIconPair(
        "Mic External",
        MaterialSymbolIcons.MicExternalOn,
        MaterialSymbolIcons.MicExternalOff,
        enabledCodeIconName = "MicExternalOn",
        disabledCodeIconName = "MicExternalOff",
    ),
    MaterialWipeIconPair(
        "Music",
        MaterialSymbolIcons.MusicNote,
        MaterialSymbolIcons.MusicOff,
        enabledCodeIconName = "MusicNote",
        disabledCodeIconName = "MusicOff",
    ),
    MaterialWipeIconPair("Mobile", MaterialSymbolIcons.Mobile, MaterialSymbolIcons.MobileOff),
    MaterialWipeIconPair(
        "Mobile Data Arrows",
        MaterialSymbolIcons.MobiledataArrows,
        MaterialSymbolIcons.MobiledataOff,
    ...
    MaterialWipeIconPair(
        "Noise Control",
        MaterialSymbolIcons.NoiseControlOn,
        MaterialSymbolIcons.NoiseControlOff,
    ...
    MaterialWipeIconPair(
        "No Accounts",
        MaterialSymbolIcons.AccountCircle,
        MaterialSymbolIcons.NoAccounts,
        enabledCodeIconName = "AccountCircle",
        disabledCodeIconName = "NoAccounts",
    ),
    MaterialWipeIconPair(
        "No Encryption",
        MaterialSymbolIcons.Lock,
        MaterialSymbolIcons.NoEncryption,
        enabledCodeIconName = "Lock",
        disabledCodeIconName = "NoEncryption",
    ),
    MaterialWipeIconPair("No Luggage", MaterialSymbolIcons.Luggage, MaterialSymbolIcons.NoLuggage),
    MaterialWipeIconPair(
        "No Meals",
        MaterialSymbolIcons.Restaurant,
        MaterialSymbolIcons.NoMeals,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.NoPhotography,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.NoTransfer,
    ...
    MaterialWipeIconPair(
        ...
        MaterialSymbolIcons.PhoneDisabled,
    ...
    MaterialWipeIconPair(
        "Play",
        MaterialSymbolIcons.PlayArrow,
        MaterialSymbolIcons.PlayDisabled,
        enabledCodeIconName = "PlayArrow",
        disabledCodeIconName = "PlayDisabled",
    ),
    MaterialWipeIconPair("Power", MaterialSymbolIcons.Power, MaterialSymbolIcons.PowerOff),
    ...
    MaterialWipeIconPair(
        "Raw",
        MaterialSymbolIcons.RawOn,
        MaterialSymbolIcons.RawOff,
...
internal val knownProblemsMaterialWipeIconCatalog = listOf(
    MaterialWipeIconPair(
        "Approval Delegation",
        MaterialSymbolIcons.ApprovalDelegation,
        MaterialSymbolIcons.ApprovalDelegationOff,
        enabledCodeIconName = "ApprovalDelegation",
        disabledCodeIconName = "ApprovalDelegationOff",
    ),
    MaterialWipeIconPair(
        "Hearing",
        MaterialSymbolIcons.Hearing,
    ...
    MaterialWipeIconPair(
        "Hearing Aid",
        MaterialSymbolIcons.HearingAid,
        MaterialSymbolIcons.HearingAidDisabled,
        enabledCodeIconName = "HearingAid",
        disabledCodeIconName = "HearingAidDisabled",
    ),
    MaterialWipeIconPair(
        "Mode Heat",
        MaterialSymbolIcons.ModeHeat,
        MaterialSymbolIcons.ModeHeatOff,
        enabledCodeIconName = "ModeHeat",
        disabledCodeIconName = "ModeHeatOff",
    ),
    MaterialWipeIconPair(
        "Tamper Detection",
        MaterialSymbolIcons.TamperDetectionOn,
        MaterialSymbolIcons.TamperDetectionOff,
        enabledCodeIconName = "TamperDetectionOn",
        disabledCodeIconName = "TamperDetectionOff",
    ),
    MaterialWipeIconPair(
        "Smart Card Reader",
        MaterialSymbolIcons.SmartCardReader,
        MaterialSymbolIcons.SmartCardReaderOff,
...
internal val howItWorksPair = coreMaterialWipeIconCatalog.first { it.label == "Power" }
